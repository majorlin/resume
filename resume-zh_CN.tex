...
\contactInfo{(+86) 185-5008-6576}{linmingjie@foxmail.com}{系统软件总监 | MCU/SoC 系统软件架构 | 芯片验证 FPGA 原型 | 10+ 年半导体经验}{}
% {E-mail}{mobilephone}
...
\begin{itemize}
  \item 参与芯片RoadMap指定，芯片需求分析，芯片架构设计，芯片模块设计和验证
  \item 负责芯片FPGA验证及硅后验证工作，确保芯片功能和性能符合设计要求
   \begin{itemize}
    ...
    \item 对芯片应用和芯片设计、芯片测试等有深入了解，能够从多个角度对芯片开发过程提出改善建议
   \end{itemize}
\end{itemize}
